...
final class TwitterApiClient {
    ...
    public static func createUserAuthenticatedClient(with credentials: Credentials) async throws -> TwitterApiClient {
        ...
        do {
            ...
            return TwitterApiClient(client: client, user: responseBody.data)
